  ...
  return (
    <footer className="mt-24 border-t border-rule">
      <div className="mx-auto max-w-[1240px] px-5 py-10">
        <div className="text-scrim text-scrim--full flex flex-col gap-6 border border-rule border-l-2 border-l-accent/45 sm:flex-row sm:items-end sm:justify-between">
          <div>
