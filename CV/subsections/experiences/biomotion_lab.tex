...
\begin{itemize}
    ...
    \item Investigated and documented a critical stereo geometry issue in \textbf{Meta XR SDK Unity} with OVRCameraRig per-eye mode, identifying an effective ~2x IPD scaling bug; built and published a reproducible test project mapping the root cause.
